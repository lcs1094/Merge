...
public class V_Monster : MonoBehaviour
{
    ...
    public void Set_SpwanZone(GameObject Zone){
        ...
        // Debug.Log("MY SPWANZONE: " + My_SpwanZone);
        // Debug.Log("MY ZONE: " + M_Zone);
    }
    ...
    void Die(){
        isDead = true;
        My_SpwanZone.GetComponent<V_Monster_Spwanzone>().Monster_State(isDead);

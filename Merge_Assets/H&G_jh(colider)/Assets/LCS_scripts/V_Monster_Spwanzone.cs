...
public class V_Monster_Spwanzone : MonoBehaviour
{
    public bool isDead;
    ...
    void OnTriggerEnter2D(Collider2D col){
        if(col.gameObject.tag == "Monster"){
            ...
            // col.gameObject.GetComponent<V_Monster>().Set_SpwanZone(this.gameObject);
        }
    }
    void OnTriggerExit2D(Collider2D col){
        if(col.gameObject.tag == "Monster"){
            //Debug.Log("Zone Out!");
            col.gameObject.GetComponent<V_Monster>().Zone_Out();
        }
    }
    ...
    void Start()
    {
        ...
        Spwan_Monster.GetComponent<V_Monster>().Set_SpwanZone(this.gameObject);
        isDead = false;
    }
